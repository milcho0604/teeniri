...
public class RedisConfig {
    ...
    public RedisConnectionFactory redisConnectionFactory() {
        ...
        redisStandaloneConfiguration.setDatabase(0); // 데이터베이스 인덱스
    ...
    @Bean
    public RedisMessageListenerContainer redisContainer(@Qualifier("redisConnectionFactory") RedisConnectionFactory connectionFactory,
    ...
    public MessageListenerAdapter listenerAdapter(ChatService chatService) {
        return new MessageListenerAdapter(chatService, "onMessage");
    }
}
